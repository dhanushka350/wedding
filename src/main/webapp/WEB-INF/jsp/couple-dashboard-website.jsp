...
<!-- Mirrored from jituchauhan.com/real-wed/realwed/couple-dashboard-website.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 13 Nov 2018 09:40:52 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->
    <title>RealWed | Couple Dashboard - Website</title>
    <!-- Bootstrap -->
                        ...
                        <div class="dropdown">
                          ...
                          <span class="user-icon">  <img src="images/dashboard-profile-couple.jpg" alt="" class="rounded-circle mb10"></span><span class="user-vendor-name">Eva J. Giles</span> 
                            ...
                            <div class=" dashboard-dropdown-menu dropdown-menu" aria-labelledby="dropdownMenuButton">
                                ...
                                <a class="dropdown-item" href="couple-dashboard-website.jsp">Website</a>
        ...
        <div class="dashboard-sidebar offcanvas-collapse">
            ...
            <div class="dashboard-nav">
                <ul class="list-unstyled">
                    ...
                    <li class="active"><a href="couple-dashboard-website.jsp"><span class="dash-nav-icon"><i class="fas fa-link"></i></span>Wedding Website </a></li>
...
<!-- Mirrored from jituchauhan.com/real-wed/realwed/couple-dashboard-website.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 13 Nov 2018 09:40:53 GMT -->
</html>