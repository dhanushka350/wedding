...
<!-- Mirrored from jituchauhan.com/real-wed/realwed/couple-dashboard-realwedding.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 13 Nov 2018 09:41:08 GMT -->
<head>
    <meta charset="utf-8">
                        ...
                        <div class="dropdown">
                          ...
                          <span class="user-icon">  <img src="images/dashboard-profile-couple.jpg" alt="" class="rounded-circle mb10"></span><span class="user-vendor-name">Eva J. Giles</span> 
                            ...
                            <div class=" dashboard-dropdown-menu dropdown-menu" aria-labelledby="dropdownMenuButton">
                                ...
                                <a class="dropdown-item" href="couple-dashboard-table-planner.jsp">Real Wedding</a>
        ...
        <div class="dashboard-sidebar offcanvas-collapse">
            ...
            <div class="dashboard-nav">
                <ul class="list-unstyled">
                    ...
                    <li class="active"><a href="couple-dashboard-profile.jsp"><span class="dash-nav-icon"><i class="fas fa-images"></i></span>Real Wedding </a></li>
                            ...
                            <form>
                                <div class="card-body">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="realwedding-featured-img">
