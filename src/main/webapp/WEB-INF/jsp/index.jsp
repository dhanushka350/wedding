...
<!-- Mirrored from jituchauhan.com/real-wed/realwed/index.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 13 Nov 2018 09:37:37 GMT -->
<head>
    <meta charset="utf-8">
            ...
            <div class="offset-xl-1 col-xl-10 offset-lg-1 col-lg-10 col-md-12 col-sm-12 col-12">
                ...
                <div class="">
                    <div class="text-center search-head">
                        ...
                        <p class="d-none d-xl-block d-lg-block d-sm-block text-white">Browse the best wedding vendors in
                            your area — from venues and photographers, to wedding planners, caterers, florists and
                            more.</p>
                    </div>
                    <!-- /.search-block -->
                    <!-- search-form -->
...
<div class="space-small">
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                <div class="venue-categories-block zoomimg">
                    <div class="venue-categories-img"><a href="#"><img src="images/venue_categories_img_1.jpg" alt=""
                                                                       class="img-fluid"></a>
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                ...
                <div class="venue-categories-block">
                    <div class="venue-categories-img zoomimg"><a href="#"><img src="images/venue_categories_img_2.jpg"
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                <!-- venue-categoris-block-->
                <div class="venue-categories-block">
                    <div class="venue-categories-img zoomimg"><a href="#"><img src="images/venue_categories_img_3.jpg"
                                                                               alt="" class="img-fluid"></a>
                        <div class="venue-categories-overlay">
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                <!-- venue-categoris-block-->
                <div class="venue-categories-block ">
                    <div class="venue-categories-img zoomimg"><a href="#"><img src="images/venue_categories_img_4.jpg"
                                                                               alt="" class="img-fluid"></a>
                        <div class="venue-categories-overlay">
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                <!-- venue-categoris-block-->
                <div class="venue-categories-block ">
                    <div class="venue-categories-img zoomimg"><a href="#"><img src="images/venue_categories_img_5.jpg"
                                                                               alt="" class="img-fluid"></a>
                        <div class="venue-categories-overlay">
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6 col-12">
                <!-- venue-categoris-block-->
                <div class="venue-categories-block">
                    <div class="venue-categories-img zoomimg "><a href="#"><img src="images/venue_categories_img_6.jpg"
                                                                                alt="" class="img-fluid"></a>
                        <div class="venue-categories-overlay">
        ...
        <!-- venue-categoris-btn -->
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 text-center mt60"><a href="#"
                                                                                            class="btn btn-default btn-lg">View
                All category</a></div>
        </div>
        <!-- /.venue-categoris-btn -->
    </div>
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="real-wedding-block">
                        ...
                        <div class="real-wedding-img zoomimg">
                            <!-- real wedding img -->
                            <a href="#"><img src="images/real-wedding-img-1.jpg"
                                             alt="Wedding Vendor & Supplier Directory HTML Template " class="img-fluid"></a>
                        </div>
                        <!-- /.real wedding img -->
                        <div class="real-wedding-content ">
                            ...
                            <div class="real-wedding-meta"><span class="real-wedding-date">07 May, 2018</span>
                                <span class="real-wedding-place pl-3"><i
                                        class="fas fa-map-marker-alt pr-1"></i>Surat</span>
                            </div>
                        </div>
                        <!-- /.real wedding img -->
                    </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="real-wedding-block">
                        ...
                        <div class="real-wedding-img zoomimg">
                            <!-- real wedding img -->
                            <a href="#"><img src="images/real-wedding-img-4.jpg"
                                             alt="Wedding Vendor & Supplier Directory HTML Template " class="img-fluid"></a>
                        </div>
                        <!-- /.real wedding img -->
                        <div class="real-wedding-content">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                    <div class="real-wedding-block">
                        ...
                        <div class="real-wedding-img zoomimg">
                            <!-- real wedding img -->
                            <a href="#"><img src="images/real-wedding-img-2.jpg"
                                             alt="Wedding Vendor & Supplier Directory HTML Template " class="img-fluid"></a>
                        </div>
                        <!-- /.real wedding img -->
                        <div class="real-wedding-content">
                            ...
                            <div class="real-wedding-meta"><span class="real-wedding-date">12 May, 2018</span>
                                <span class="real-wedding-place pl-3"><i
                                        class="fas fa-map-marker-alt pr-1"></i>Pune</span>
            ...
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                <div class="feature feature-icon-block">
                    ...
                    <div class="feature-content">
                        ...
                        <p>Sed scelerisque mauris eget erat sodales, sed aliquet elit commodo. Pellentesque ultrices
                            pellentesque tellus eu malesuada. </p>
                    </div>
                </div>
            </div>
            <!-- /.feature-block-->
            ...
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                <div class="feature feature-icon-block">
                    ...
                    <div class="feature-content">
                        ...
                        <p>Proin sollicitudin quis risus ut mattis. Interdum et malesuada fames arbi nulla lacus,
                            pretium at lobortis non, finibus quis odio. </p>
                    </div>
                </div>
            </div>
            <!-- /.feature-block-->
            ...
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                <div class="feature feature-icon-block">
                    ...
                    <div class="feature-content">
                        ...
                        <p>Nam euismod magna et neque consectetur imperdie traesent ut arcu sit amet nunc sollicitudin
                            fringilla.</p>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                <div class="testimonial-block">
                    ...
                    <p class="testimonial-text">“Cras non maximus velit. Nam eleifend nibh eget erat gravida, ac
                        fermentum turpis iaculis. Aliquam hendrerit ornare dui, rutrum luctus ipsum aliquam non. Cras
                        non maximus velit.”</p>
                    <div class="testimonial-pic"><img src="images/testimonial-1.jpg" class="rounded-circle" alt="">
                    </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                <div class="testimonial-block">
                    ...
                    <p class="testimonial-text">“Nam eleifend nibh eget erat gravida, ac fermentum turpis iaculis.
                        Aliquam hendrerit ornare dui, rutrum luctus ipsum aliquam stibulum ut dignissim sem. Cras non
                        maximus velit. ”</p>
                    <div class="testimonial-pic"><img src="images/testimonial-2.jpg" class="rounded-circle" alt="">
                    </div>
                    <div class="testimonial-meta">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                <div class="testimonial-block">
                    ...
                    <p class="testimonial-text">“Vestibulum ut dignissim sem. Cras non maximus velit. Nam eleifend nibh
                        eget erat gravida, ac fermentum turpis iaculis. Aliquam hendrerit lorem ispuimi, um aliquam
                        non.”</p>
                    <div class="testimonial-pic"><img src="images/testimonial-3.jpg" class="rounded-circle" alt="">
                    </div>
                    <div class="testimonial-meta">
...
<!-- Mirrored from jituchauhan.com/real-wed/realwed/index.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 13 Nov 2018 09:38:15 GMT -->
</html>