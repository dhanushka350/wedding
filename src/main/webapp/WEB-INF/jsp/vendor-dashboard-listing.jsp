...
<!-- Mirrored from jituchauhan.com/real-wed/realwed/vendor-dashboard-listing.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 13 Nov 2018 09:40:19 GMT -->
<head>
    <meta charset="utf-8">
                        ...
                        <div class="dropdown">
                           ...
                           <span class="user-icon"> <img src="images/dashboard-profile.jpg" alt="" class="rounded-circle mb10"></span><span class="user-vendor-name">John Deo</span> 
                            ...
                            <div class=" dashboard-dropdown-menu dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item" href="vendor-dashboard-overview.jsp">Dashboard</a>
                                <a class="dropdown-item" href="vendor-dashboard-listing.jsp"> My Listed Item </a>
                                <a class="dropdown-item" href="vendor-dashboard-pricing.jsp">Pricing Plan</a>
                                <a class="dropdown-item" href="vendor-dashboard-request-quote.jsp">Request Quotes</a>
                                <a class="dropdown-item" href="vendor-dashboard-reviews.jsp">Reviews </a>
                                <a class="dropdown-item" href="vendor-dashboard-profile.jsp">My Profile </a>
        ...
        <div class="dashboard-sidebar offcanvas-collapse">
            ...
            <div class="dashboard-nav">
                <ul class="list-unstyled">
                    <li><a href="vendor-dashboard-overview.jsp"><span class="dash-nav-icon"><i class="fas fa-compass"></i></span>Dashboard</a></li>
                    <li class="active"><a href="vendor-dashboard-listing.jsp"><span class="dash-nav-icon"><i class="fas fa-list-alt"></i> </span> My Listed Item </a></li>
                    <li><a href="vendor-dashboard-pricing.jsp"><span class="dash-nav-icon"><i class="fas fa-calculator"></i></span>Pricing Plan</a></li>
                    <li><a href="vendor-dashboard-request-quote.jsp"><span class="dash-nav-icon"><i class="fas fa-edit"></i></span>Request Quotes</a></li>
                    <li><a href="vendor-dashboard-reviews.jsp"><span class="dash-nav-icon"><i class="fas fa-comments"></i></span>Reviews </a></li>
                    <li><a href="vendor-dashboard-profile.jsp"><span class="dash-nav-icon"><i class="fas fa-user-circle"></i></span>My Profile </a></li>
                    <li><a href="index.jsp"><span class="dash-nav-icon"><i class="fas fa-sign-out-alt"></i></span>Logout </a></li>
                </ul>
            </div>
        </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 text-right mb20">
                        <a href="vendor-dashboard-add-listing.jsp" class="btn btn-default btn-sm">add new Listing</a>
                    </div>
                </div>
...
<!-- Mirrored from jituchauhan.com/real-wed/realwed/vendor-dashboard-listing.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 13 Nov 2018 09:40:26 GMT -->
</html>