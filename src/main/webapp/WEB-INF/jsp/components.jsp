...
<!-- Mirrored from jituchauhan.com/real-wed/realwed/components.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 13 Nov 2018 09:40:18 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->
    <title>RealWed | Wedding Vendor & Supplier Directory HTML Template - Components</title>
    <!-- Bootstrap -->
...
<body>
            ...
            <div class="row">
                ...
                <div class="col-xl-6 col-lg-6 col-sm-6 col-md-6 col-sm-12 col-12">
                    <div class="header-text text-right">
                        <p>Are You Vendor?<a href="vendor-form.jsp" class="text-white">List Your Business</a></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-xl-2 col-lg-2 col-md-12 col-sm-12 col-12">
                    ...
                    <div class="header-logo">
                        <a href="index.jsp"><img src="images/logo.png" alt="Wedding Vendor & Supplier Directory HTML Template "></a>
                    </div>
                    <!-- /.header-logo -->
                </div>
                    ...
                    <div id="navigation">
                        <ul>
                            <li><a href="#" title="#">Homepages</a>
                                <ul>
                                    <li><a href="index.jsp" title="">Homepage 1</a></li>
                                    <li><a href="index-2.jsp" title="">Homepage 2</a></li>
                                     <li><a href="index-3.jsp" title="">Homepage 3</a></li>
                                </ul>
                            </li>
                            <li><a href="#" title="#">Vendors</a>
                                <ul>
                                    <li><a href="#" title="">Listing</a>
                                        <ul>
                                            <li><a href="list-grid-view.jsp" title="">List Grid View</a></li>
                                            <li><a href="list-view-sidebar.jsp" title="">List View Sidebar</a></li>
                                            <li><a href="list-half-screen-map.jsp" title="">List Half Screen Map</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="#" title="">List Single</a>
                                        <ul>
                                            <li><a href="list-single-1.jsp" title="">List Single 1</a></li>
                                            <li><a href="list-single-2.jsp" title="">List Single 2</a></li>
                                             <li><a href="list-single-3.jsp" title="">List Single With Video</a></li>
                                              <li><a href="list-single-4.jsp" title="">List Single With Gallery</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="vendor-category.jsp" title="">Vendor By Categories</a></li>
                                    <li><a href="vendor-location.jsp" title="">Vendor By Locations</a></li>
                                </ul>
                            </li>
                            <li><a href="#" title="#">Suppliers</a>
                                <ul>
                                    <li><a href="supplier-dresses-list.jsp" title="">Dresses</a></li>
                                    <li><a href="supplier-cake-list.jsp" title="">Cakes</a></li>
                                    <li><a href="supplier-florist-list.jsp" title="">Florist</a></li>
                                    <li><a href="supplier-photographer-list.jsp" title="">Photographers</a></li>
                                    <li><a href="supplier-videographer-list.jsp" title="">Videographer</a></li>
                                </ul>
                            </li>
                            <li><a href="#" title="#">Real Weddings</a>
                                <ul>
                                    <li><a href="real-wedding-list.jsp" title="">Real Weddings List</a></li>
                                    <li><a href="real-wedding-single.jsp" title="">Real Weddings Single</a></li>
                                </ul>
                            </li>
                                ...
                                <ul>
                                    <li><a href="#" title="">Pages</a>
                                        <ul>
                                            ...
                                            <li><a href="team-page.jsp" title="">Meet the Team</a></li>
                                            <li><a href="pricing.jsp" title="">Pricing</a></li>
                                    ...
                                    <li><a href="#" title="">Forms</a>
                                        <ul>
                                            <li><a href="vendor-form.jsp" title="">Vendors Form</a></li>
                                            <li><a href="couple-form.jsp" title="">Couple Form</a></li>
                                            <li><a href="forgot-password.jsp" title="">Forgot Password</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="#" title="">Help Center</a>
                                        <ul>
                                            <li><a href="help-center.jsp" title="">Help Center</a></li>
                                            <li><a href="help-category-list.jsp" title="">Help Category List</a></li>
                                            <li><a href="help-category-single.jsp" title="">Help Category Single</a></li>
                                        </ul>
                                    </li>
                            ...
                            <li><a href="#" title="">User Panel</a>
                                <ul>
                                    <li><a href="#" title="">Vendor Dashboard</a>
                                        <ul>
                                            <li><a href="vendor-dashboard-overview.jsp" title="">Dashboard</a></li>
                                            <li><a href="vendor-dashboard-listing.jsp" title="">Listing</a></li>
                                            <li><a href="vendor-dashboard-add-listing.jsp" title="">Add Listing</a></li>
                                            <li><a href="vendor-dashboard-pricing.jsp" title="">Pricing</a></li>
                                            <li><a href="vendor-dashboard-request-quote.jsp" title="">Request Quote</a></li>
                                            <li><a href="vendor-dashboard-reviews.jsp" title="">Reviews</a></li>
                                            <li><a href="vendor-dashboard-profile.jsp" title="">   Profile</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="#" title="">Couple Dashboard</a>
                                        <ul>
                                            <li><a href="couple-dashboard-overview.jsp" title="">Dashboard</a></li>
                                            <li><a href="couple-dashboard-mywishlist.jsp" title="">My Listing</a></li>
                                            <li><a href="couple-dashboard-todolist.jsp" title="">To Do List</a></li>
                                            <li><a href="couple-dashboard-budget.jsp" title="">Budget</a></li>
                                            <li><a href="couple-dashboard-guest-manager.jsp" title="">Guest Manager</a></li>
                                            <li><a href="couple-dashboard-add-new-guest.jsp" title="">Add New Guest</a></li>
                                            <li><a href="couple-dashboard-table-planner.jsp" title="">Seating Table</a></li>
                                            <li><a href="couple-dashboard-profile.jsp" title="">   Profile</a></li>
                                        </ul>
                                    </li>
                                    <li><a href="couple-rsvp-page.jsp" title="">RSVP</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
                    <div class="page-caption">
                        <h1 class="page-title">Comoponets</h1>
                    </div>
                </div>
                <!-- /.page caption -->
            </div>
    ...
    <div class="content">
        <div class="container" id="top">
            <div class="row">
                <div class="col-xl-10">
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="section-block" id="typo">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body border-top">
                                    <h5 class="card-title">Body Text</h5>
                                ...
                                <div class="card-body border-top">
                                    <h5 class="card-title">Inline Text</h5>
                                    <div class="card-body">
                                        <h4 class="text-left">Left aligned text.</h4>
                                    ...
                                    <div class="card-body border-top">
                                        <h4 class="text-right">Right aligned text.</h4>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body border-top">
                                    ...
                                    <a href="#" class="btn btn-default btn-xs">XSmall button</a>
                                </div>
                                <div class="card-body border-top">
                                    <h4>Block Level Buttons</h4>
                                    <a href="#" class="btn btn-default btn-block">Block level button</a>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="section-block" id="color">
                                <h3 class="section-heading">Color</h3>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="p-3 mb-2 bg-default text-white">.bg-default</div>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="section-block" id="accordions">
                                <h3 class="section-heading">Accordions</h3>
                                <p>Using the card component, you can extend the default collapse behavior to create an accordion.</p>
                            </div>
                            <div class="card">
                                <h5 class="card-header">Accordion Style One</h5>
                                <div class="card-body">
                                    <div id="accordion">
                                        <!-- accordion-card -->
      ...
      Accordion Heading Title here #1 </a></h5>
                                            </div>
                    ...
                    Accordion Heading Title here #2
                             </a>
                                </h5>
                                            </div>
                 ...
                 Accordion Heading Title here #3
                       </a>
                             </h5>
                                            </div>
                ...
                Accordion Heading Title here #4</a>
                             </h5>
                                            </div>
              ...
              Accordion Heading Title here #5
                       </a>
                             </h5>
                                            </div>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="section-block" id="tabs">
                            ...
                            <div class="card">
                                <h5 class="card-header">Tabs Style</h5>
                                <div class="card-body">
                                    <div class="st-tab">
                                        <!-- st-tabs -->
                                        <ul class="nav nav-tabs" id="Mytabs" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" id="tab-1" data-toggle="tab" href="#tab1" role="tab" aria-controls="tab-1" aria-selected="true">Tab #1</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" id="tab-2" data-toggle="tab" href="#tab2" role="tab" aria-controls="tab-2" aria-selected="false">Tab #2</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" id="tab-3" data-toggle="tab" href="#tab3" role="tab" aria-controls="tab-3" aria-selected="false">Tab #3</a>
                                            </li>
                                        </ul>
                                        <div class="tab-content" id="myTabContent">
                                            <div class="tab-pane fade show active" id="tab1" role="tabpanel" aria-labelledby="tab-1">
                                                <h4>Tab #1</h4>
                                                <p>Luctuset ultrices posuere cubiliaurae urabitur nonex rutrum elit lacinia faucibust eget est erosivamus egettitor nisiat volutpat felisras sed nisl dictum sagittis metus</p>
                                                <p> etegestas diamenean in ante vitae sem sagittis condimentLuctuset ultrices posuere cubiliaurae urabitur nonex rutrum elit lacinia faucibust eget est erosivamus egettitor nisiat volutpat felisras sed nisl dictum sagittis metus etegestas diamenean in ante vitae sem sagittis cond ummetus etegestas diamenean in ante vitae sem sagittismetus etegestas diameneanin ante vitae.</p>
                                            </div>
                                            <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="tab-2">
                                                <h4>Tab #2</h4>
                                                <p>Faucibus orci luctuset ultrices posuere cubiliaurae urabitur nonex rutrum elit lacinia faucibust eget est erosivamus eget porttitor nisiat volutpat felisras sed nisl dictum sagittis metus etegestas diamenean in ante vitae sem sagittis condiment ummetus etegestas diamenean in ante vitae sem sagittismetus etegestas diamenean.</p>
                                                <p>Morbi tempor suscipit augue sit amet sodaleuis volutpat pellentesque magnaut fringilla lacus tincidunt acaecenast estvel ut fringilla lacus tincidunt acaecenas idseron.</p>
                                            </div>
                                            <div class="tab-pane fade" id="tab3" role="tabpanel" aria-labelledby="tab-3">
                                                <h4>Tab #3</h4>
                                                <p>Urabitur nonex rutrum elit lacinia faucibust eget est erosivamus eget porttitor nisiat volutpat felisras sed nisl dictum sagittis metus etegestas diamenean in ante vitae sem sagittis condiment ummetus etegestas diamenean in ante vitae sem sagittismetus etegestas diameneanin ante vitae.</p>
                                                <p>Lacus sapienonec nibh just viverra sitamet exac lobortis faucibus est. Morbi suscipit est in luctus volutpatenean sollicitudin tincidunt estvel ut fringilla lacus tincidunt acaecenas idseron.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card">
                                <h5 class="card-header">Pills Style</h5>
                                <div class="card-body">
                                    <div class="st-tab">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            ...
                            <div class="card">
                                ...
                                <div class="">
                                    ...
                                    <div class="card-body border-top">
                                        <h4>Dot Badges</h4>
                                        <span class="mr-2"> <span class="badge-dot badge-default"></span>Default</span>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="section-block" id="tooltip">
                                <h3 class="section-heading">Tooltips & Popover</h3>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="section-block" id="modal">
                                <h3 class="section-heading">Modals</h3>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="section-block" id="pagination">
                                <h3 class="section-heading">Paginations</h3>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="section-block" id="breadcrumbs">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body border-top">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb bg-transparent border-bottom rounded-0">
                                            <li class="breadcrumb-item active" aria-current="page">Home</li>
                                        </ol>
                                    </nav>
                                    <nav aria-label="breadcrumb">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="section-block" id="list">
                                <h3 class="section-heading">List Group</h3>
                            ...
                            <div class="card">
                                <h5 class="card-header">List Group</h5>
                                <div class="card-body">
                                    <h4>Basic example</h4>
                                    <ul class="list-group">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="section-block" id="form">
                                <h3 class="section-heading">Forms</h3>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form>
                                        ...
                                        <select class="custom-select mb20">
                ...
                <div class="col-xl-2">
                    <div class="sidebar-nav-fixed">
                        <ul class="list-unstyled">
                            ...
                            <li><a href="#list">List Group</a></li>
