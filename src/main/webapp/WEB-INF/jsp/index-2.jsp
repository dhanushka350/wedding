...
<!-- Mirrored from jituchauhan.com/real-wed/realwed/index-2.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 13 Nov 2018 09:38:15 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->
    <title>RealWed - Wedding Venue &amp; Supplier Directory HTML Template </title>
    <!-- Bootstrap -->
    ...
    <div class="header header-second">
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-4 col-md-2 col-sm-12 col-12 d-none d-xl-block d-lg-block text-right">
                    <div class="header-btn">
                        <a href="couple-form.jsp" class="btn btn-primary btn-sm">Login</a>
                        <a href="couple-form.jsp" class="btn btn-primary btn-sm">Sign up</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="offset-xl-1 col-xl-10 offset-lg-1 col-lg-10 col-md-12 col-sm-12 col-12">
                    <div class="hero-section-caption">
                        <div class="text-center search-head">
                            ...
                            <p class="d-none d-xl-block d-lg-block d-sm-block text-white">Choose from 500+ local wedding venues, services and providers.</p>
                        </div>
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-3 col-md-4 col-sm-12 col-12">
                    <div class="venue-categories-block">
                        <div class="venue-categories-img zoomimg"> <a href="#"><img src="images/vendor-cat-img-1.jpg" alt="" class="img-fluid"></a>
                ...
                <div class="col-xl-4 col-lg-3 col-md-4 col-sm-12 col-12">
                    <div class="venue-categories-block">
                        <div class="venue-categories-img zoomimg"> <a href="#"><img src="images/vendor-cat-img-2.jpg" alt="" class="img-fluid"></a>
                            <div class="venue-categories-overlay">
                                <h3 class="mb0"><a href="#" class="venue-categories-title">Photographer (14)</a></h3>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-3 col-md-4 col-sm-12 col-12">
                    <div class="venue-categories-block">
                        <div class="venue-categories-img zoomimg"> <a href="#"><img src="images/vendor-cat-img-3.jpg" alt="" class="img-fluid"></a>
                            <div class="venue-categories-overlay">
                                <h3 class="mb0"><a href="#" class="venue-categories-title">Florist (16)</a></h3>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-3 col-md-4 col-sm-12 col-12">
                    <div class="venue-categories-block ">
                        <div class="venue-categories-img zoomimg"> <a href="#"><img src="images/vendor-cat-img-4.jpg" alt="" class="img-fluid"></a>
                            <div class="venue-categories-overlay">
                                <h3 class="mb0"><a href="#" class="venue-categories-title">Hair & Makeup (18)</a></h3>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-3 col-md-4 col-sm-12 col-12">
                    <div class="venue-categories-block">
                        <div class="venue-categories-img zoomimg"> <a href="#"><img src="images/vendor-cat-img-5.jpg" alt="" class="img-fluid"></a>
                            <div class="venue-categories-overlay">
                                <h3 class="mb0"><a href="#" class="venue-categories-title">Wedding DJ(12)</a></h3>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-3 col-md-4 col-sm-12 col-12">
                    <div class="venue-categories-block">
                        <div class="venue-categories-img zoomimg"> <a href="#"><img src="images/vendor-cat-img-6.jpg" alt="" class="img-fluid"></a>
                            <div class="venue-categories-overlay">
                                <h3 class="mb0"><a href="#" class="venue-categories-title">Videographer (11)</a></h3>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="offset-xl-2 col-xl-8 offset-lg-2 col-lg-8 col-md-12 col-sm-12 col-12">
                    <div class="section-title text-center">
                        <!-- section title start-->
                        <h2 class="mb10">Couple Wedding Planning Tools</h2>
                        <p>Phasellus congue felis nec lacus volutpat, vitae lacinia ante facilisis.</p>
                    </div>
                    <!-- /.section title start-->
                </div>
            </div>
                ...
                <div class="col-xl-2 col-lg-2 col-md-3 col-sm-12 col-12">
                    <div class="vendor-feature-block feature-block">
                        ...
                        <div class="feature-content">
                            <h3 class="feature-title"><a href="#">Checklist</a></h3>
                        </div>
                    </div>
                </div>
                <div class="col-xl-2 col-lg-2 col-md-3 col-sm-12 col-12">
                    <div class="vendor-feature-block feature-block">
                        ...
                        <div class="feature-content">
                            <h3 class="feature-title"><a href="#">Guest List</a></h3>
                        </div>
                    </div>
                </div>
                <div class="col-xl-2 col-lg-2 col-md-3 col-sm-12 col-12">
                    <div class="vendor-feature-block feature-block">
                        ...
                        <div class="feature-content">
                            <h3 class="feature-title"><a href="#">Seating Chart</a></h3>
                        </div>
                    </div>
                </div>
                <div class="col-xl-2 col-lg-2 col-md-3 col-sm-12 col-12">
                    <div class="vendor-feature-block feature-block">
                        ...
                        <div class="feature-content">
                            <h3 class="feature-title"><a href="#">Vendor Manager</a></h3>
                        </div>
                    </div>
                </div>
                <div class="col-xl-2 col-lg-2 col-md-3 col-sm-12 col-12">
                    <div class="vendor-feature-block feature-block">
                        ...
                        <div class="feature-content">
                            <h3 class="feature-title"><a href="#">Budget</a></h3>
                        </div>
                    </div>
                </div>
                <div class="col-xl-2 col-lg-2 col-md-3 col-sm-12 col-12">
                    <div class="vendor-feature-block feature-block">
                        ...
                        <div class="feature-content">
                            <h3 class="feature-title"><a href="#">RSVP</a></h3>
                        </div>
                    </div>
                </div>
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 text-center mt40"><a href="#" class="btn btn-default btn-lg mb20">Start Planning</a>
                    <p>Already have an account? <a href="#" class="text-default">Login</a></p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="offset-xl-2 col-xl-8 offset-lg-2 col-lg-8 col-md-12 col-sm-12 col-12">
                    <div class="section-title text-center">
                        ...
                        <p>Phasellus aliquam massa vestibulum ex pharetra, nec faucibus ex dictum.</p>
                    </div>
                    <!-- /.section title start-->
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                    <div class="post-block text-center">
                        ...
                        <!-- post block -->
                        <div class="meta">
                            <span class="meta-category">Florist</span>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                ...
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                    <div class="post-block text-center">
                        ...
                        <!-- post block -->
                        <div class="meta">
                            <span class="meta-category">Videography</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-8 col-sm-12 col-12">
                    <div class="cta-section">
                        <h1 class="text-white">Get The Wedding App </h1>
                        <p class="mb40">Wedding planning app to get things done aenean non dui a nunc imperdie hendrerit vitae non nun estibulum metus elit.</p>
                        <a href="#"><img src="images/app-store-icon.png" alt="" class="img-fluid"></a>
...
<!-- Mirrored from jituchauhan.com/real-wed/realwed/index-2.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 13 Nov 2018 09:38:18 GMT -->
</html>