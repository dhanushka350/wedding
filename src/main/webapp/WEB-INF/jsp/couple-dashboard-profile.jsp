...
<!-- Mirrored from jituchauhan.com/real-wed/realwed/couple-dashboard-profile.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 13 Nov 2018 09:40:45 GMT -->
<head>
    <meta charset="utf-8">
        ...
        <div class="dashboard-sidebar offcanvas-collapse">
            ...
            <div class="dashboard-nav">
                <ul class="list-unstyled">
                    ...
                    <li class="active"><a href="couple-dashboard-profile.jsp"><span class="dash-nav-icon"><i class="fas fa-user-circle"></i></span>My Profile </a></li>
                                            ...
                                            <div class="row">
                                                <div class="col-xl-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="weddingdate" name="weddingdate" type="text" placeholder="" class="form-control" required="">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control select wide" id="Country">
                                                ...
                                                <div class="col-xl-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control select wide" id="State">
                                                 ...
                                                 <div class="col-xl-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control select wide" id="City">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xl-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="bridefname" name="bridefname" type="text" placeholder="" class="form-control " required="">
                                                    </div>
                                                </div>
                                                <div class="col-xl-6">
                                                    <div class="form-group">
                                                        <label class="control-label" for="bridelname">Bride Last Name</label>
                                                        <input id="bridelname" name="bridelname" type="text" placeholder="" class="form-control " required="">
                                                    </div>
                                                </div>
                                                <div class="col-xl-6">
                                                    <div class="form-group">
                                                        <label class="control-label" for="groomfname">Groom First Name</label>
                                                        <input id="groomfname" name="groomfname" type="text" placeholder="" class="form-control " required="">
                                                    </div>
                                                </div>
                                                <div class="col-xl-6">
                                                    <div class="form-group">
                                                        <label class="control-label" for="groomlname">Groom last Name</label>
                                                        <input id="groomlname" name="groomlname" type="text" placeholder="" class="form-control " required="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
