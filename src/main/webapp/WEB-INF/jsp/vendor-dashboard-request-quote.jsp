...
<!-- Mirrored from jituchauhan.com/real-wed/realwed/vendor-dashboard-request-quote.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 13 Nov 2018 09:40:29 GMT -->
<head>
    <meta charset="utf-8">
        ...
        <div class="dashboard-sidebar offcanvas-collapse">
            ...
            <div class="dashboard-nav">
                <ul class="list-unstyled">
                    ...
                    <li><a href="vendor-dashboard-listing.jsp"><span class="dash-nav-icon"><i class="fas fa-list-alt"></i> </span> My Listed Item </a></li>
                    <li><a href="vendor-dashboard-pricing.jsp"><span class="dash-nav-icon"><i class="fas fa-calculator"></i></span>Pricing Plan</a></li>
                    <li class="active"><a href="vendor-dashboard-request-quote.jsp"><span class="dash-nav-icon"><i class="fas fa-edit"></i></span>Request Quotes</a></li>
