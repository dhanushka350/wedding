...
<!-- Mirrored from jituchauhan.com/real-wed/realwed/index-3.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 13 Nov 2018 09:40:46 GMT -->
<head>
    <meta charset="utf-8">
...
<body>
            ...
            <div class="row">
                <div class="col-xl-2 col-lg-2 col-md-12 col-sm-12 col-12">
                    ...
                    <div class="header-logo">
                        <a href="index.jsp"><img src="images/logo-white.png" alt="Wedding Vendor & Supplier Directory HTML Template "></a>
                    </div>
                    <!-- /.header-logo -->
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                        <div class="feature-left">
                            ...
                            <div class="feature-content">
                                <h3 class="text-white mb-1">12000+</h3>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
                        <div class="feature-left">
                            ...
                            <div class="feature-content">
                                ...
                                <p class="text-white">Worldwide Cities</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
    ...
    <!-- /.blog-post-section -->
    <div class="space-medium bg-primary text-white">
        <div class="container">
            <div class="row">
                <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12 col-12">
                    <h1 class="text-white mb10">Submit your Listing Right Now!</h1>
                    <p>Lorem ipsum dolor sit amet consectetur adipiscing elit, sed do eiusmod tempor.</p>
                </div>
                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12 text-center mt-3">
                    <a href="#" class="btn btn-white btn-lg">Submit Now</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12">
                    <div class="footer-widget">
                        ...
                        <p class="d-flex"><i class="fas fa-fw fa-map-marker-alt text-default pr-3 pt-1"></i>4998 Elk Creek Road Canton,
                            <br> GA 30114</p>
