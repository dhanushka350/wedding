...
<!-- Mirrored from jituchauhan.com/real-wed/realwed/vendor-dashboard-pricing.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 13 Nov 2018 09:40:29 GMT -->
<head>
    <meta charset="utf-8">
        ...
        <div class="dashboard-sidebar offcanvas-collapse">
            ...
            <div class="dashboard-nav">
                <ul class="list-unstyled">
                    ...
                    <li class="active"><a href="vendor-dashboard-pricing.jsp"><span class="dash-nav-icon"><i class="fas fa-calculator"></i></span>Pricing Plan</a></li>
