...
<!-- Mirrored from jituchauhan.com/real-wed/realwed/couple-dashboard-table-planner.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 13 Nov 2018 09:40:44 GMT -->
<head>
    <meta charset="utf-8">
        ...
        <div class="dashboard-sidebar offcanvas-collapse">
            ...
            <div class="dashboard-nav">
                <ul class="list-unstyled">
                    ...
                    <li class="active"><a href="couple-dashboard-table-planner.jsp"><span class="dash-nav-icon"><i class="fas fa-table"></i></span>Seating Table </a></li>
...
<!-- Mirrored from jituchauhan.com/real-wed/realwed/couple-dashboard-table-planner.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 13 Nov 2018 09:40:45 GMT -->
</html>