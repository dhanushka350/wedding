...
<!-- Mirrored from jituchauhan.com/real-wed/realwed/list-view-sidebar.jsp by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 13 Nov 2018 09:38:22 GMT -->
<head>
    <meta charset="utf-8">
                        ...
                        <div class="row">
                            <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 border-right pr-0">
                                <div class="vendor-img">
                                    <!-- Vendor img -->
                                    <a href="#"><div class="zoomimg"><img src="images/vendor-img-1.jpg" alt="" class="img-fluid"></div></a>
                    ...
                    <div class="vendor-thumbnail list-view">
                        <div class="row">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 border-right pr-0">
                                <div class="vendor-img">
                                    <!-- Vendor img -->
                                    <a href="#"><div class="zooming"><img src="images/vendor-img-2.jpg" alt=""  class="img-fluid"></div></a>
                                    <div class="wishlist-sign"><a href="#" class="btn-wishlist"><i class="fa fa-heart"></i></a></div>
                                </div>
                            </div>
                            <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12 pl-0">
                    ...
                    <div class="vendor-thumbnail list-view">
                        ...
                        <div class="row">
                            <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 border-right pr-0">
                                <div class="vendor-img">
                                    <!-- Vendor img -->
                                    <a href="#"><div class="zooming"><img src="images/vendor-img-3.jpg" alt=""  class="img-fluid"></div></a>
                                    <div class="wishlist-sign"><a href="#" class="btn-wishlist"><i class="fa fa-heart"></i></a></div>
                                </div>
                            </div>
                            <!-- /.Vendor img -->
                    ...
                    <div class="vendor-thumbnail list-view">
                        <div class="row">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 border-right pr-0">
                                <div class="vendor-img">
                                    <!-- Vendor img -->
                                    <a href="#"><div class="zooming"><img src="images/vendor-img-4.jpg" alt=""  class="img-fluid"></div></a>
                                    <div class="wishlist-sign"><a href="#" class="btn-wishlist"><i class="fa fa-heart"></i></a></div>
                                </div>
                            </div>
                            <!-- /.Vendor img -->
